...
namespace YoutubeCollections.Database
{
    public class SqlConst
    {
        ...
        public static string InsertVideoSql = @"insert into Videos (YoutubeID,ChannelID,Title,Thumbnail,Duration,ViewCount,PublishedAt) values ('{0}',{1},'{2}','{3}','{4}',{5},'{6}');";

        public static string SelectAllChannelsSql = @"select ChannelID,YoutubeID,Title from channels;";
